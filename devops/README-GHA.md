...
2. Go to your repository at [collective/volto-footer-project](https://github.com/collective/volto-footer-project).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `volto-footer-project.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | volto-footer-project.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | volto-footer-project.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/volto-footer-project/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/volto-footer-project/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/volto-footer-project-backend`) and Frontend (`ghcr.io/collective/volto-footer-project-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of volto-footer-project.example.com](https://github.com/collective/volto-footer-project/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/volto-footer-project.example.com.yml` stack.
